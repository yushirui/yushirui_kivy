...
# Author：余时锐
# Date: 2020-06-22
# Message：yushirui0222_StackLayout堆栈布局
# 文件系统
import os
...
# 标题
App.title = 'yushirui0222_StackLayout堆栈布局'
...
class YushiruiWidget(StackLayout):
    ...
    def __init__(self, **kwargs):
        ...
        btn = Button(text='Yushirui0508App', width=60)
        btn.bind(on_press=self.yushirui_middle_button_do)
        # 布局加组件（按钮）
        self.add_widget(btn)

    def yushirui_middle_button_do(self, *args):
        from yushirui_21_kivy.yushirui0508_TabbedPanel选项卡 import Yushirui0508App
        # 窗口
